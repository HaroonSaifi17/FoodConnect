    ...
    <div className="bg-red-50 py-9">
      <div className="flex px-[5vw] items-center mx-auto gap-5 max-md:flex-col justify-center  max-w-screen-2xl mt-8">
        <div className="max-w-lg">
          <h1 className="text-5xl font-semibold">Feed the <span className="text-orange-600">Hungery</span></h1>
          <p className="mt-4">
          ...
          <Link className="py-2 px-4 rounded-full bg-red-500 text-white" to="/need">NEED FOOD</Link>
          <a className="py-2 px-4 rounded-full bg-green-600 text-white" href="#donate">I WANT TO HELP</a>
          </div>
        </div>
